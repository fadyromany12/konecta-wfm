...
export default function AdminHierarchyPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-semibold text-slate-50">Organization hierarchy</h1>
      <p className="text-slate-400">Full org tree. Each node shows name, role, and email.</p>
