...
import projectSessionsRoutes from "./modules/projectSessions/routes";
import meRoutes from "./modules/me/routes";
import breakConfigRoutes from "./modules/breakConfig/routes";
import rtaRoutes from "./modules/rta/routes";
import gridRoutes from "./modules/grid/routes";
...
app.use("/api/break-config", breakConfigRoutes);
